...
class SleepTrackerViewModel(
    ...
    // Escopo da MainThread.
    // Toda Coroutine lançada com esse escopo vai rodar em background e, ao retornar, estará no contexto da
    // MainThread
    ...
    fun doneNavigation() {
        _navigateToSleepQuality.postValue(null)
    }
    ...
    fun onSleepNightClicked(nightId: Long) {
        _navigateToSleepDataQuality.postValue(nightId)
    }
